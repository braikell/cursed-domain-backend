...
-- Canonical healing/self-sustain ultimate tuning.
-- These rows must carry the full ultimate payload, not only healing deltas,
-- because some remote catalogs may still have null or partial ultimate JSON.
